...
task = Task.init(project_name='HyperSearch', task_name='221_SR_Search', task_type=Task.TaskTypes.optimizer)
...
space = {
    ...
    'learning_rate': lambda: sample(range(*params['learning_rate']), 1)[0]/100
}
...
template_task = Task.get_task(project_name='train', task_name='221_SequenceR_origin')
