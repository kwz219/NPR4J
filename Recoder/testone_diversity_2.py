...
def fix_diversity(model_path,ids_f,input_dir,search_size,fix_dir,classcontent_dir):
    ...
    diversity_failed=[]
    sub_ids=diversity_ids[4000:8000]
...
if __name__ == '__main__':
    import argparse
    fix_diversity("/root/zwk/Recorder/save_new/best_model.ckpt","/root/zwk/Recoder_diversity/final.ids","/root/zwk/Recoder_diversity",150,
                  "/root/zwk/Recoder_diversity/results","/root/zwk/Recoder_diversity/classcontents")
    """"
