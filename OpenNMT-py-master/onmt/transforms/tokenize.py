...
class TokenizerTransform(Transform):
    """Tokenize transform abstract class."""

    def __init__(self, opts):
        """Initialize necessary options for Tokenize."""
        super().__init__(opts)
...
class ONMTTokenizerTransform(TokenizerTransform):
    """OpenNMT Tokenize transform class."""

    def __init__(self, opts):
        """Initialize necessary options for OpenNMT Tokenize."""
        super().__init__(opts)
    ...
    @classmethod
    def _validate_options(cls, opts):
        """Extra checks for OpenNMT Tokenize options."""
    ...
    def _tokenize(self, tokens, side='src', is_train=False):
        """Do OpenNMT Tokenize's tokenize."""
    ...
    def apply(self, example, is_train=False, stats=None, **kwargs):
        """Apply OpenNMT Tokenize to src & tgt."""
