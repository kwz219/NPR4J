...
def preprocess(ids: list, method, input_dir, output_dir):
    ...
    if method == "SequenceR":
        ...
        build(output_dir + "val.buggy_7", output_dir + "val.fix_7", output_dir + "val.fids_7",
              output_dir + "val.sids_7", ids)
...
def test_preprocess():
    ...
    preprocess(val_ids[70000:], "SequenceR", "E:\\bug-fix\\", "D:\DDPR_DATA\OneLine_Replacement\M1000_SequenceR\\")
