...
def preprocess(ids: list, method, input_dir, output_dir):
    ...
    if method == "SequenceR":
        ...
        build(output_dir + "val.buggy_5", output_dir + "val.fix_5", output_dir + "val.fids_5",
              output_dir + "val.sids_5", ids)
...
def test_preprocess():
    ...
    preprocess(val_ids[50000:60000], "SequenceR", "E:\\bug-fix\\", "D:\DDPR_DATA\OneLine_Replacement\M1000_SequenceR\\")
