...
def calculate_min_samples(ids_f,buggy_lines_dir,buggy_lines_f,output_f):
    ...
    for idx, id in enumerate(sub_ids):
        if True:
            ...
            print(idx)
calculate_min_samples("/root/zwk/Analyze/final.ids","/root/zwk/NPR_DATA0306/Evaluationdata/Diversity/buggy_lines","/root/zwk/NPR_DATA0306/train_lines/train_lines.buggy","/root/zwk/Analyze/all.ids5")