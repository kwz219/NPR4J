    ...
    if method=="SequenceR":
        def build(src_f, tgt_f, error_f, correct_f,ids):
            ...
            for id in ids:
                ...
                tmp_f="D:\DDPR_TEST\SR_AB\\tmp\\"+buggy_parent_f.split("\\")[0]+"_"+buggy_parent_f.split("\\")[-1]
        ...
        build(output_dir+"buggy.trn.txt",output_dir+"fix.trn.txt",output_dir+"error_ids.trn.txt",output_dir+"correct_ids.trn.txt",trn_ids)
...
def test_preprocess():
    ...
    preprocess(trn_ids,val_ids,"SequenceR","E:\\bug-fix\\","D:\DDPR_TEST\SR_AB\\")
