...
from CodeAbstract.CA_SequenceR import run_SequenceR_abs, run_SequenceR_abs_p2
    ...
    if method == "SequenceR":
        def build(src_f, tgt_f, error_f, correct_f, ids):
            ...
            for id in ids:
                ...
                buggy_code, hitflag = run_SequenceR_abs_p2(input_dir + buggy_parent_f, tmp_f, bug)
        ...
        build(output_dir + "val.buggy_4", output_dir + "val.fix_4", output_dir + "val.fids_4",
              output_dir + "val.sids_4", ids)
...
def test_preprocess():
    ...
    preprocess(val_ids[40000:50000], "SequenceR", "E:\\bug-fix\\", "D:\DDPR_DATA\OneLine_Replacement\M1000_SequenceR\\")
