...
def preprocess(ids: list, method, input_dir, output_dir):
    ...
    if method == "SequenceR":
        ...
        build(output_dir + "val.buggy_2", output_dir + "val.fix_2", output_dir + "val.fids_2",
              output_dir + "val.sids_2", ids)
...
def test_preprocess():
    ...
    preprocess(val_ids[20000:30000], "SequenceR", "E:\\bug-fix\\", "D:\DDPR_DATA\OneLine_Replacement\M1000_SequenceR\\")
