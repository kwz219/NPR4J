...
def preprocess(ids: list, method, input_dir, output_dir):
    ...
    if method == "SequenceR":
        ...
        build(output_dir + "val.buggy_3", output_dir + "val.fix_3", output_dir + "val.fids_3",
              output_dir + "val.sids_3", ids)
...
def test_preprocess():
    ...
    preprocess(val_ids[30000:40000], "SequenceR", "E:\\bug-fix\\", "D:\DDPR_DATA\OneLine_Replacement\M1000_SequenceR\\")
