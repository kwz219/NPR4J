...
from ..data.gpt_language_pair_with_context_dataset import GPT2LanguagePairWithContextDataset


@register_task('cure')
class Cure(FairseqTask):
    """
    ...
    def setup_task(cls, args, **kwargs):
        print("start to setup task cure")
    ...
    def load_dataset(self, split, combine=False, **kwargs):
        ...
        self.datasets[split]=GPT2LanguagePairWithContextDataset(
