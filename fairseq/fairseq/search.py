...
class Cure_BeamSearch(Cure_Search):
...
class Cure_DiverseBeamSearch(Cure_Search):
    def __init__(self, tokenizer, num_groups, diversity_strength):
        super().__init__(tokenizer)
        self.num_groups = num_groups
        self.diversity_strength = -diversity_strength
        self.diversity_buf = None
        self.beam = Cure_BeamSearch(tokenizer)
