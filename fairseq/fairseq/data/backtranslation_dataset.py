...
class BacktranslationDataset(FairseqDataset):
        ...
        **kwargs
        ...
        Args:
            tgt_dataset: dataset which will be used to build self.tgt_dataset --
                a LanguagePairDataset with tgt dataset as the CoCoNut dataset and
            ...
            remove_eos_at_src: whether we should remove EOS from the CoCoNut
    ...
    def collater(self, samples):
        ...
        with best score as the CoCoNut and the orignal net input as the target.
        """
        ...
        # {id: id, CoCoNut: generated backtranslation, target: original tgt}
        generated_samples = []
        for input_sample, hypos in zip(samples, backtranslation_hypos):
            original_tgt = input_sample["CoCoNut"].cpu()
            ...
            # The generated CoCoNut dialect backtranslation will have an EOS.
            # If we want our parallel data CoCoNut to not have an EOS, we will
            # have to remove it.
